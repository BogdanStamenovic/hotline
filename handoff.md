...
>   bot-question check (link 22's note). Chunk 38: BR-31 WIDENED (NO EU *or Serbian* traffic to Singapore; ZZPL art. 65, so in practice the primary must be EU-scoped) and BR-32 (OpenRouter zdr:true / Jev and Parasail
